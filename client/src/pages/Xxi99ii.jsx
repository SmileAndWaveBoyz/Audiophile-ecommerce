            ...
            <main>
                <div className="xx99miiPage-blockContainer">
                    ...
                    <div className="xx99miiPage-blockContainer-image-box">
                        <img src="./assets/product-xx99-mark-two-headphones/mobile/1.png" alt="A man relaxing with headphones" />
                        <img src="./assets/product-xx99-mark-two-headphones/mobile/2.png" alt="A table with headphones and a phone on it" />
                        <img src="./assets/product-xx99-mark-two-headphones/mobile/3.png" alt="A close up of the XX99 Mark II Headphones" />
                    </div>
